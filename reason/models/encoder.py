...
class Encoder(BaseRNN):
        ...
        def __init__(self, vocab_size, max_len, word_vec_dim, hidden_size, n_layers,
            ...
            if word2vec is not None:
                ...
                self.embedding = keras.layers.Embedding(vocab_size, word_vec_dim)
            if fix_embedding:
                self.embedding.trainable=False
            self.rnn = self.rnn_cell(self.word_vec_dim, hidden_size, n_layers, batch_first=True, bidirectional=bidirectional, dropout=dropout_p)
